...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			txt.setFont(Font.font(STYLESHEET_MODENA, 24));
			...
			zeroBtn.setFont(Font.font(STYLESHEET_MODENA, 24));
			zeroBtn.setMinSize(140+gp.getHgap(), 50);
			gp.add(zeroBtn,0,6,2,1);
			for(int i=1;i<=9;i++)	{
				String numStr = numAndOps[i];
				Button numBtn = m.createButton(numStr, input, txt);
				numBtn.setFont(Font.font(STYLESHEET_MODENA, 24));
			...
			for(int i=10;i<15;i++)	{
				...
				opBtn.setFont(Font.font(STYLESHEET_MODENA, 24));
			...
			equalBtn.setMinSize(70, 100+gp.getVgap());
			equalBtn.setFont(Font.font(STYLESHEET_MODENA, 24));
			...
			clearBtn.setFont(Font.font(STYLESHEET_MODENA, 24));
			clearBtn.setMinSize(70, 50);
			...
			bkspBtn.setFont(Font.font(STYLESHEET_MODENA, 24));
			bkspBtn.setMaxSize(70, 50);
			bkspBtn.setMinSize(70, 50);
